            ...
            <div class="row">
                <div class="col-12">
                            ...
                            <div class="modal fade bs-example-modal-xl-tutorial" tabindex="-1" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-xl">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body"> 
                                            <video controls>
                                                <source src="vistas/videos/ccmdd.mp4" type="video/mp4">
                    ...
                    <div class="col-xxl-12">
                        <h5 class="mb-3">POLÍTICA CONOZCA A SU CLIENTE - FORMULARIO DE DEBIDA DILIGENCIA CLIENTE PERSONA NATURAL - CÓDIGO: PCR-CUMP-FORM01</h5>
                        <div class="card">
                            <div class="card-body">
                                                                                        ...
                                                                                        <div class="row gy-4">
                                                                                            ...
                                                                                            <div class="col-xxl-3 col-md-6">
                                                                                                <div>
                                                                                                    ...
                                                                                                    <textarea class="form-control" name="fui_comentario_1"></textarea>
                                                                                                </div>
                                                                                            </div>
                                                                                            <!--end col-->
                                                                                            <div class="col-xxl-3 col-md-6">
                                                                                            ...
                                                                                            <div class="col-xxl-3 col-md-6">
                                                                                                <div>
                                                                                                    <label for="basiInput" class="form-label">Comentaro</label>
                                                                                                    <textarea class="form-control" name="fui_comentario_2"></textarea>
                                                                                                </div>
                                                                                            </div>
                                                                                            <!--end col-->
                                                                                            <div class="col-xxl-3 col-md-6">
                                                                                            ...
                                                                                            <div class="col-xxl-3 col-md-6">
                                                                                                <div>
                                                                                                    <label for="basiInput" class="form-label">Comentaro</label>
                                                                                                    <textarea class="form-control" name="fui_comentario_3"></textarea>
                                                                                                </div>
                                                                                            </div>
                                                                                            <!--end col-->
                                                                                            <div class="col-xxl-3 col-md-6">
                                                                                            ...
                                                                                            <div class="col-xxl-3 col-md-6">
                                                                                                <div>
                                                                                                    <label for="basiInput" class="form-label">Comentaro</label>
                                                                                                    <textarea class="form-control" name="fui_comentario_4"></textarea>
                                                                                                </div>
                                                                                            </div>
                                                                                            <!--end col-->
                                                                                            <div class="col-xxl-3 col-md-6">
