            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a href="index.php" class="logo logo-dark">
                        <span class="logo-sm">
                            <img src="assets/images/logonf.png" alt="" height="22">
                        </span>
                        <span class="logo-lg">
                            <img src="assets/images/logonf.png" alt="" height="17">
                        </span>
                    </a>
                    ...
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            ...
                            <span class="text-start ms-xl-2">
                                <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text"><?php echo $_SESSION['usuario'][0]['nombre']; ?></span>
                                <span class="d-none d-xl-block ms-1 fs-12 text-muted user-name-sub-text">Puesto</span>
                            </span>
                        </span>
                    </button>
                    <div class="dropdown-menu dropdown-menu-end">
