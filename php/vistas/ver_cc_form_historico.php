            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="col-xxl-12">
                        <h5 class="mb-3">HISTORICO CLIENTES REGISTRADOS - APROBADO</h5>
                        <div class="card">
                            <div class="card-body">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <h5 class="card-title mb-0">Clientes Aprobados</h5>
                                            </div>
                                            <div class="card-body">
                                                <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                                                    ...
                                                    <tbody>
                                                        <?php foreach ($todos_registros_cc_historico  as $key => $value) { ?>
                                                        <tr>
