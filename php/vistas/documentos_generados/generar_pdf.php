                ...
                <div class="col-sm-12">
                    ...
                    $html .= '<table class="table" style="width:90%; font-size: 10px; text-align:center;" border="1">
                        <tbody>
                            <tr>
                                <td><b>FECHA</b></td>
                                <td>'.$value["exp_fecha"].'</td>
                            </tr>
                            <tr>
                                <td><b>CLIENTE</b></td>
                                <td>'.$value["exp_cliente"].'</td>
                            </tr>
                            <tr>
                                <td><b>MARCA</b></td>
                                <td>'.$value["exp_marca"].'</td>
                            </tr>
                            <tr>
                                <td><b>MODELO</b></td>
                                <td>'.$value["exp_modelo"].'</td>
                            </tr>
                            <tr>
                                <td><b>AÑO</b></td>
                                <td>'.$value["exp_anio"].'</td>
                            </tr>
                            <tr>
                                <td><b>PLACA</b></td>
                                <td>'.$value["exp_placa"].'</td>
                            </tr>
                            <tr>
                                <td><b>CHASIS</b></td>
                                <td>'.$value["exp_chasis"].'</td>
                            </tr>
                            <tr>
                                <td><b>MOTOR</b></td>
                                <td>'.$value["exp_motor"].'</td>
                            </tr>
                            <tr>
                                <td><b>COLOR</b></td>
                                <td>'.$value["exp_color"].'</td>
                            </tr>
                            <tr>
                                <td><b>CÓDIGO DOLLAR</b></td>
                                <td>'.$value["exp_codigo_dollar"].'</td>
                            </tr>
                            <tr>
                                <td><b>N° INTELISIS</b></td>
                                <td>'.$value["exp_n_intelisis"].'</td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    $html .= '<table class="table" style="width:90%; font-size: 10px; text-align:center;" border="1">
                        <tbody>
                            ...
                            <tr>
                                <td>COPIA DE SEGUNDA IDENTIFICACIÓN</td>
                                <td></td>
                            </tr>
                            <tr>
                                <td>COPIA DE CARTA DE TRABAJO, FICHA O TALONARIO</td>
                                <td></td>
                            </tr>
                            <tr>
                                <td>COPIA DE AVISO DE OPERACIONES</td>
                                <td>'.$bien_aviso_operaciones.'</td>
                            </tr>
                            <tr>
                    ...
                    <table class="table" style="width:90%; font-size: 10px; text-align:center;" border="1">
                        <tbody>
                            ...
                            <tr>
                            <td>DETALLE DE TRANSACCIONES DE PAGO</td>
                            <td></td>
                            </tr>
                            <tr>
                            <td>PROFORMA</td>
