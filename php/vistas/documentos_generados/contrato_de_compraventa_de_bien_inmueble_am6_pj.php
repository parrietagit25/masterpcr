...
$html = '<div class="container" style="font-size: 9px;">
            <div class="row">
                ...
                $html .= '<table class="table" style="width:90%; font-size: 9px;">
                        ...
                        Sección 4: (Condiciones de Garantía): Salvo las limitaciones o exclusiones indicadas en este documento EL VENDEDOR otorga una garantía de seis (6) meses o 15.000KM, lo que ocurra primero, en el bloque del motor y la transmisión únicamente. <br>
