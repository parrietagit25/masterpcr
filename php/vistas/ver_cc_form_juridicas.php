                ...
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            ...
                            <button type="button" class="btn btn-warning " data-bs-toggle="modal" data-bs-target=".bs-example-modal-xl-tutorial">TUTORIAL</button>
                            ...
                            <!-- Tutorial -->
                            <div class="modal fade bs-example-modal-xl-tutorial" tabindex="-1" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-xl">
                                    <div class="modal-content">
                                        <div class="modal-header">
                    ...
                    <div class="col-xxl-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <!-- Solicitar Revicion -->
                                <div class="modal fade solicitar_revicion" tabindex="-1" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content" style="text-align: center;">
                                            <form action="" method="post">
                                                <div class="modal-header">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div id="contenido_modal_solicitar_revicion">

                                                    </div>
                                                </div>
                                                <div class="modal-footer">
                                                    <a href="javascript:void(0);" class="btn btn-link link-success fw-medium" data-bs-dismiss="modal"><i class="ri-close-line me-1 align-middle"></i> Cerrar</a>
                                                    <input type="submit" value="Solicitar Revicion" class="btn btn-primary" name="solicitar_revicion">
                                                </div>
                                            </form>
                                        </div><!-- /.modal-content -->
                                    </div><!-- /.modal-dialog -->
                                ...
                                <!-- Aprobacion -->
                                <div class="modal fade aprobacion" tabindex="-1" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content" style="text-align: center;">
                                            <form action="" method="post">
                                                <div class="modal-header">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div id="contenido_modal_aprobacion">

                                                    </div>
                                                </div>
                                                <div class="modal-footer">
                                                    <a href="javascript:void(0);" class="btn btn-link link-success fw-medium" data-bs-dismiss="modal"><i class="ri-close-line me-1 align-middle"></i> Cerrar</a>
                                                    <input type="submit" value="Aprobar" class="btn btn-primary" name="aprobar">
                                                </div>
                                            </form>
                                        </div><!-- /.modal-content -->
                                    </div><!-- /.modal-dialog -->
                                ...
                                <!-- aprobar analista -->
                                <div class="modal fade solicitar_aprobacion_analista_pj" tabindex="-1" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content" style="text-align: center;">
                                            <form action="" method="post">
                                                <div class="modal-header">
                                                ...
                                                <div class="modal-body">
                                                    <h6 class="fs-15">
                                                        Pedir la aprobacion del analista
                                                    </h6>
                                                    <div id="contenido_modal_solicitar_aprobacion_analista_pj">

                                                    </div>
                                                </div>
                                                <div class="modal-footer">
                                                    <a href="javascript:void(0);" class="btn btn-link link-success fw-medium" data-bs-dismiss="modal"><i class="ri-close-line me-1 align-middle"></i> Cerrar</a>
                                                    <input type="submit" value="Pedir aprobacion" class="btn btn-primary" name="solicitar_aprobacion_analista">
                                                </div>
                                            </form>
                                        </div><!-- /.modal-content -->
                                    </div><!-- /.modal-dialog -->
