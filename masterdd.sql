...
--
-- Servidor: db
-- Tiempo de generación: 31-05-2023 a las 15:34:57
...
CREATE TABLE `cc_adjuntos` (
  `id` int NOT NULL,
  `id_general` int DEFAULT NULL,
  `fdcad_documento_identidad` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fdcad_recibo` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fdcad_aviso_operaciones` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fdcad_evidencia_ingresos` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `cc_beneficiario` (
  `id` int NOT NULL,
  `id_general` int DEFAULT NULL,
  `fb_cliete_tercero` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fb_relacion_familiar_tercero` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fb_relacion_detalle` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fb_primer_nombre` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fb_segundo_nombre` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fb_apellido_paterno` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fb_apellido_materno` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fb_apellido_casada` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fb_pais_nacimiento` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fb_fecha_nacimiento` date DEFAULT NULL,
  `fb_nacionaidad` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fb_genero` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fb_estado_civil` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fb_identificacion` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fb_pais_residencia` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fb_direccion_residencial` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fb_pais_residencia_fiscal` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fb_email` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fb_telefono_residencia` varchar(15) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fb_telefono_movil` varchar(15) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fb_profesion` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fb_ocupacion` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fb_lugar_trabajo` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fb_direccion_trabajo` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `cc_declaracion` (
  `id` int NOT NULL,
  `id_general` int DEFAULT NULL,
  `fd_actividad_principal` varchar(5) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fd_otras_fuentes` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fd_limite_compra` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fd_metodo_pago_1` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fd_metodo_pago_2` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fd_forma_pago_1` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `cc_declaracion_jurada` (
  `id` int NOT NULL,
  `id_general` int DEFAULT NULL,
  `fdc_nombre_completo` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fdc_fecha` date DEFAULT NULL,
  `fdc_firma` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `cc_expediente` (
  ...
  `exp_cliente` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `exp_marca` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `exp_modelo` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `exp_anio` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `exp_placa` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `exp_chasis` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `exp_motor` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `exp_color` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `exp_codigo_dollar` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `exp_n_intelisis` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `cc_generales` (
  `id` int NOT NULL,
  `fg_primer_nombre` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fg_segundo_nombre` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fg_apellido_paterno` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fg_apellido_materno` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fg_apellido_casada` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fg_pais_nacimiento` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fg_fecha_nacimiento` date DEFAULT NULL,
  `fg_nacionalidad` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fg_genero` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fg_estado_civil` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fg_cedula` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fg_pais_residencia` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fg_direccion_residencial` varchar(250) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fg_pais_residencia_fiscal` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fg_email` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fg_telefono_residencia` varchar(15) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fg_telefono_movil` varchar(15) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
(2, '', '', '', '', '', '', '1970-01-01', '', '', '', '', '', '', '', '', '', '', 1, '2023-05-30 04:40:52', 1),
(13, '', '', '', '', '', '', '1970-01-01', '', '', '', '', '', '', '', '', '', '', 1, '2023-05-31 14:50:13', 1),
...
CREATE TABLE `cc_ocupacionales` (
  `id` int NOT NULL,
  `id_general` int DEFAULT NULL,
  `fo_profesion` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fo_ocupacion` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fo_lugar_trabajo` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fo_direccion_trabajo` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fo_correo_trabajo` varchar(80) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fo_telefono_trabajo` varchar(15) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fo_nombre_negocio` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fo_aviso_operaciones` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fo_licita_estado` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fo_pais_residencia_fiscal` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `cc_personas_expuestas` (
  `id` int NOT NULL,
  `id_general` int DEFAULT NULL,
  `fp_beneficiario` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fp_nombre_completo` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fp_cargo_actual` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fp_otro` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fp_fecha` date DEFAULT NULL,
  `fp_cargo_anterior` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fp_fecha_anterior` date DEFAULT NULL,
  `fp_comentario` varchar(250) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `cc_pj_adjuntos` (
  `id` int NOT NULL,
  `id_general` int DEFAULT NULL,
  `pjad_identificacion` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjad_pacto_social` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjad_aviso_operaciones` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjad_evidencia_ingreso` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `cc_pj_apoderados` (
  `id` int NOT NULL,
  `id_general` int DEFAULT NULL,
  `pja_nombre_completo` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pja_cargo` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pja_nacionalidad` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pja_id` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pja_correo` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pja_direccion` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pja_telefono` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `cc_pj_apoderados_temp` (
  `id` int NOT NULL,
  `a_temp_id_session` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `a_temp_nombre_completo` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `a_temp_cargo` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `a_temp_nacionalidad` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `a_temp_id` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `a_temp_correo` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `a_temp_direccion` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `a_temp_telefono` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `cc_pj_beneficiario_declaracion_jurada` (
  `id` int NOT NULL,
  `id_general` int DEFAULT NULL,
  `pjbdj_nombre_completo` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjbdj_fecha` date DEFAULT NULL,
  `pjbdj_firma` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `cc_pj_beneficiario_final` (
  `id` int NOT NULL,
  `id_general` int DEFAULT NULL,
  `pjbf_transpaso_cliente_tercero` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjbf_relacion_cliente` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjbf_primer_nombre` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjbf_segundo_nomnbre` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjbf_apellido_parterno` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjbf_apellido_materno` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjbf_apellido_casada` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjbf_pais_nacimiento` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjbf_fecha_nacimiento` date DEFAULT NULL,
  `pjbf_nacionalidad` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjbf_genero` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjbf_cedula_pasaporte` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjbf_estado_civil` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjbf_pais_residencia` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjbf_pais_residencia_fiscal` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjbf_direccion_residencia` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjbf_correo` varchar(80) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjbf_telefono_residencial` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjbf_telefono_celular` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjbf_profesion` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjbf_ocupacion` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjbf_lugar_trabajo` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjbf_direccion_trabajo` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `cc_pj_declaracion_accionista` (
  `id` int NOT NULL,
  `id_general` int DEFAULT NULL,
  `pjda_nombre_completo_accionista` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjda_participacion_accionaria` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `cc_pj_declaracion_fuentes` (
  `id` int NOT NULL,
  `id_general` int DEFAULT NULL,
  `pjdf_actividad_principal` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjdf_actividad_secundaria` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjdf_otras_fuentes` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjdf_otras_fuentes_secundaria` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjdf_limite_compra` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjdf_forma_pago` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjdf_metodo_pago_1` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjdf_metodo_pago_2` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `cc_pj_declaracion_jurada` (
  `id` int NOT NULL,
  `id_general` int DEFAULT NULL,
  `pjdj_nombre_completo` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjdj_fecha` date DEFAULT NULL,
  `pjdj_firma` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `cc_pj_declaracion_jurada_2` (
  `id` int NOT NULL,
  `id_general` int DEFAULT NULL,
  `p_jdj_nombre_completo_2` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `p_jdj_fecha_2` date DEFAULT NULL,
  `p_jdj_firma_2` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `cc_pj_directiva_dignatarios` (
  `id` int NOT NULL,
  `id_general` int DEFAULT NULL,
  `pjdd_nombre_completo` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjdd_cargo` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjdd_nacionalidad` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjdd_id` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjdd_correo` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjdd_direccion` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjdd_telefono` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `cc_pj_directiva_dignatarios_temp` (
  `id` int NOT NULL,
  `jd_temp_id_session` varchar(250) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `jd_temp_nombre_completo` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `jd_temp_cargo` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `jd_temp_nacionalidad` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `jd_temp_id` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `jd_temp_correo` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `jd_temp_direccion` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `jd_temp_telefono` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `cc_pj_expediente` (
  ...
  `pjexp_cliente` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjexp_marca` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjexp_modelo` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjexp_anio` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjexp_placa` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjexp_chasis` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjexp_motor` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjexp_color` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjexp_codigo_dollar` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjexp_n_intelisis` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `cc_pj_generales` (
  ...
  `pjgn_razon_social` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjgn_nombre_comercial` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjgn_datos_inscripcion` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjgn_tipo_persona` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjgn_direccion_fisica` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjgn_pais_constitucion` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjgn_residencia_fiscal` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjgn_ruc_dv` varchar(60) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjgn_telefono` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjgn_apartado_postal` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjgn_aviso_operacion` varchar(60) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjgn_licencia` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjgn_entidad_reguladora` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjgn_actividad_principal_dedica` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjgn_descripcion_negocio` varchar(250) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjgn_paises_ofrece_productos_servicios` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjgn_contacto` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjgn_email` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjgn_cargo` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
(15, 1, 1, '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', NULL, '', '', '2023-05-30 05:03:28');
...
CREATE TABLE `cc_pj_generales_beneficiarios_juridica` (
  `id` int NOT NULL,
  `id_general` int DEFAULT NULL,
  `gbfpj_nombre_completo_accionista` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `gbfpj_pais_constitucion` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `gbfpj_fecha_constitucion` date DEFAULT NULL,
  `gbfpj_tipo_pj` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `gbfpj_direccion` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `gbfpj_ruc` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `gbfpj_sector_economico` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `gbfpj_telefono` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `gbfpj_porcentaje_participacion` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `cc_pj_generales_beneficiarios_juridica_temp` (
  `id` int NOT NULL,
  `gbfpj_temp_id_session` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `gbfpj_temp_nombre_completo_accionista` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `gbfpj_temp_pais_constitucion` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `gbfpj_temp_fecha_constitucion` date DEFAULT NULL,
  `gbfpj_temp_tipo_pj` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `gbfpj_temp_direccion` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `gbfpj_temp_ruc` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `gbfpj_temp_sector_economico` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `gbfpj_temp_telefono` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `gbfpj_temp_porcentaje_participacion` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `cc_pj_generales_beneficiarios_natural` (
  `id` int NOT NULL,
  `id_general` int DEFAULT NULL,
  `pjgbf_nombre_completo` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjgbf_genero` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjgbf_identificacion` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjgbf_nacionalidad` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjgbf_pais_nacimiento` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjgbf_fecha_nacimiento` date DEFAULT NULL,
  `pjgbf_pais_residencia` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjgbf_pais_residencia_fiscal` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjgbf_profesion_oficio` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjgbf_lugar_trabajo` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjgbf_telefono` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjgbf_correo` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjgbf_domicilio_laboral` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjgbf_domicilio_personal` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjgbf_porcentaje_participacion` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `cc_pj_generales_bf` (
  `id` int NOT NULL,
  `id_general` int DEFAULT NULL,
  `gbf_nombre_completo` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `gbf_genero` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `gbf_identificacion` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `gbf_nacionalidad` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `gbf_pais_nacimiento` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `gbf_fecha_nacimiento` date DEFAULT NULL,
  `gbf_pais_residencia` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `gbf_pais_residencia_fiscal` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `gbf_profesion` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `gbf_lugar_trabajo` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `gbf_telefono` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `gbf_correo_electronico` varchar(80) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `gbf_domicilio_personal` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `gbf_participacion` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `cc_pj_generales_bf_temp` (
  `id` int NOT NULL,
  `id_general` int DEFAULT NULL,
  `gbf_temp_nombre_completo` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `gbf_temp_genero` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `gbf_temp_identificacion` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `gbf_temp_nacionalidad` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `gbf_temp_pais_nacimiento` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `gbf_temp_fecha_nacimiento` date DEFAULT NULL,
  `gbf_temp_pais_residencia` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `gbf_temp_pais_residencia_fiscal` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `gbf_temp_profesion` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `gbf_temp_lugar_trabajo` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `gbf_temp_telefono` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `gbf_temp_correo_electronico` varchar(80) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `gbf_temp_domicilio_personal` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `gbf_temp_participacion` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `gbf_temp_id_session` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `cc_pj_perosnas_expuestas` (
  `id` int NOT NULL,
  `id_general` int DEFAULT NULL,
  `pjpx_relacion_directa` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjpx_nombre_completo` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjpx_cargo_actual` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjpx_cargo_anterior` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjpx_fecha_cargo_actual` date DEFAULT NULL,
  `pjpx_fecha_cargo_anterior` date DEFAULT NULL,
  `pjpx_comentarios` varchar(250) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjpx_pep_relacion_directa` varchar(5) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjpx_nombre_completo_2` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjpx_cargo_actual_2` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjpx_fecha_cargo_actual_2` date DEFAULT NULL,
  `pjpx_cargo_anterior_2` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjpx_fecha_cargo_anterior_2` date DEFAULT NULL,
  `pjpx_comentarios_2` varchar(250) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `cc_pj_propietarios` (
  `id` int NOT NULL,
  `id_general` int DEFAULT NULL,
  `pjpr_publica_privada` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjpr_licita_estado` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjpr_licita_pais` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjpr_cotiza_bolsa` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjpr_descripcion_cotiza_bolsa` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjpr_nombre_bolsa_ticker` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `cc_pj_propietarios_beneficiarios_juridica` (
  `id` int NOT NULL,
  `id_general` int DEFAULT NULL,
  `pjpbj_nombre_completo` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjpbj_genero` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjpbj_cedula_pasaporte` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjpbj_nacionalidad` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjpbj_pais_nacimineto` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjpbj_fecha_nacimiento` date DEFAULT NULL,
  `pjpbj_pais_residencia` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjpbj_pais_residencia_fiscal` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjpbj_profesion_oficio` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjpbj_lugar_trabajo` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjpbj_telefono` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjpbj_correo` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjpbj_domicilio_laboral` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjpbj_domicilio_personal` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjpbj_entidad_participa` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjpbj_porcentaje_participacion` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `cc_pj_propietarios_beneficiarios_juridica_temp` (
  `id` int NOT NULL,
  `pjpbj_temp_id_session` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjpbj_temp_nombre_completo` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjpbj_temp_genero` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjpbj_temp_cedula_pasaporte` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjpbj_temp_nacionalidad` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjpbj_temp_pais_nacimiento` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjpbj_temp_fecha_nacimiento` date DEFAULT NULL,
  `pjpbj_temp_pais_residencia` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjpbj_temp_pais_residencia_fiscal` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjpbj_temp_profesion_oficio` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjpbj_temp_lugar_trabajo` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjpbj_temp_telefono` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjpbj_temp_correo` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjpbj_temp_domicilio_laboral` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjpbj_temp_domicilio_personal` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjpbj_temp_entidad_participa` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjpbj_temp_porcentaje_participacion` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `cc_pj_referencias` (
  `id` int NOT NULL,
  `id_general` int DEFAULT NULL,
  `pjrf_nombre_razon_social` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjrf_actividad` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjrf_relacion` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjrf_telefono` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjrf_correo_electronico` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `cc_pj_representante_legal` (
  `id` int NOT NULL,
  `id_general` int DEFAULT NULL,
  `pjrl_nombre_completo` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjrl_cedula_pasaporte` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjrl_estado_civil` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjrl_nacionalidada` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjrl_fecha_nacimiento` date DEFAULT NULL,
  `pjrl_direccion` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjrl_correo` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjrl_profesion` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjrl_lugar_trabajo` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjrl_telefono` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `cc_pj_terceros_autorizados` (
  `id` int NOT NULL,
  `id_general` int DEFAULT NULL,
  `pjtu_transpaso_cliente_tercero` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjtu_relacion_cliente` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjtu_primer_nombre` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjtu_segundo_nomnbre` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjtu_apellido_parterno` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjtu_apellido_materno` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjtu_apellido_casada` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjtu_pais_nacimiento` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjtu_fecha_nacimiento` date DEFAULT NULL,
  `pjtu_nacionalidad` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjtu_genero` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjtu_cedula_pasaporte` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjtu_estado_civil` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjtu_pais_residencia` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjtu_pais_residencia_fiscal` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjtu_direccion_residencia` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjtu_correo` varchar(80) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjtu_telefono_residencial` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjtu_telefono_celular` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjtu_profesion` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjtu_ocupacion` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjtu_lugar_trabajo` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjtu_direccion_trabajo` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `cc_pj_uso_interno` (
  `id` int NOT NULL,
  `id_general` int DEFAULT NULL,
  `pjui_nombre_completo_1` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjui_aprobacion_1` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjui_fecha_1` date DEFAULT NULL,
  `pjui_nombre_completo_2` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjui_aprobacion_2` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjui_fecha_2` date DEFAULT NULL,
  `pjui_nombre_completo_3` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjui_aprobacion_3` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjui_fecha_3` date DEFAULT NULL,
  `pjui_nombre_completo_4` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pjui_aprobacion_4` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
INSERT INTO `cc_pj_uso_interno` (`id`, `id_general`, `pjui_nombre_completo_1`, `pjui_aprobacion_1`, `pjui_fecha_1`, `pjui_nombre_completo_2`, `pjui_aprobacion_2`, `pjui_fecha_2`, `pjui_nombre_completo_3`, `pjui_aprobacion_3`, `pjui_fecha_3`, `pjui_nombre_completo_4`, `pjui_aprobacion_4`, `pjui_fecha_4`) VALUES
...
CREATE TABLE `cc_referencias` (
  `id` int NOT NULL,
  `id_general` int DEFAULT NULL,
  `fr_razon_social_1` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fr_actividad_1` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fr_relacion_cliente_1` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fr_telefono_1` varchar(15) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fr_correo_electronico_1` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fr_razon_social_2` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fr_actividad_2` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fr_relacion_cliente_2` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fr_telefono_2` varchar(15) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fr_correo_electronico_2` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `cc_terceros_autorizados` (
  `id` int NOT NULL,
  `id_general` int DEFAULT NULL,
  `ft_cliete_tercero` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ft_relacion_familiar_tercero` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ft_relacion_detalle` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ft_primer_nombre` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ft_segundo_nombre` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ft_apellido_paterno` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ft_apellido_materno` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ft_apellido_casada` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ft_pais_nacimiento` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ft_fecha_nacimiento` date DEFAULT NULL,
  `ft_nacionaidad` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ft_genero` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ft_estado_civil` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ft_identificacion` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ft_pais_residencia` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ft_direccion_residencial` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ft_pais_residencia_fiscal` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ft_email` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ft_telefono_residencia` varchar(15) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ft_telefono_movil` varchar(15) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ft_profesion` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ft_ocupacion` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ft_lugar_trabajo` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ft_direccion_trabajo` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `cc_uso_interno` (
  `id` int NOT NULL,
  `id_general` int DEFAULT NULL,
  `fui_nombre_completo_1` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fui_aprobacion_1` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fui_fecha_1` date DEFAULT NULL,
  `fui_nombre_completo_2` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fui_aprobacion_2` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fui_fecha_2` date DEFAULT NULL,
  `fui_nombre_completo_3` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fui_aprobacion_3` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fui_fecha_3` date DEFAULT NULL,
  `fui_nombre_completo_4` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fui_aprobacion_4` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
INSERT INTO `cc_uso_interno` (`id`, `id_general`, `fui_nombre_completo_1`, `fui_aprobacion_1`, `fui_fecha_1`, `fui_nombre_completo_2`, `fui_aprobacion_2`, `fui_fecha_2`, `fui_nombre_completo_3`, `fui_aprobacion_3`, `fui_fecha_3`, `fui_nombre_completo_4`, `fui_aprobacion_4`, `fui_fecha_4`) VALUES
(3, 13, '', '', '1970-01-01', '', '', '1970-01-01', '', '', '1970-01-01', '', '', '1970-01-01'),
(4, 14, '', '', '1970-01-01', '', '', '1970-01-01', '', '', '1970-01-01', '', '', '1970-01-01');
...
CREATE TABLE `codigos` (
  ...
  `detalle_programa` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `paises` (
  `id` int NOT NULL,
  `codigo` varchar(2) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `usuarios` (
  ...
  `tipo_user` varchar(10) COLLATE utf8mb4_general_ci NOT NULL,
